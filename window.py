...
-------------------------------------------------
Date: 01 07 2022
Description：This part is used for graphical interface to detect camera, video and picture files
-------------------------------------------------
"""
...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.vid_source = '0'  #initial camera
        self.stopEvent = threading.Event()
        self.webcam = True
        self.stopEvent.clear()
        self.model = self.model_load(weights="runs/train/Helmet_Vest/best.pt",
                                     device=self.device)
        self.initUI()
        self.reset_vid()
    ...
    def model_load(self, weights="",  # model.pt path(s)
        ...
        print("model is already settled")
        return model
    ...
    def initUI(self):
        ...
        img_detection_title = QLabel("function for image detection")
        ...
        up_img_button = QPushButton("upload images")
        ...
        self.webcam_detection_btn = QPushButton("camera real-time detection")
        self.mp4_detection_btn = QPushButton("video document detection")
    ...
    ***image detection***
    ...
    def detect_img(self):
        ...
        print(source)
        if source == "":
            QMessageBox.warning(self, "pls upload an image", "pls upload sth before detection")
        else:
            source = str(source)
